...
const KINDS = {
  ...
  // 회의 전에 부모에게 보내는 개최 안내문 본문
  notice: {
    system: `${BASE_RULE} 지금 쓸 것은 어린이집 운영위원회 개최 안내문의 본문입니다. ` +
      '첫 문장은 학부모님께 드리는 짧은 인사로 시작합니다. 이어서 운영위원회를 여는 취지를 한두 문장으로 밝히고, ' +
      '알려준 일시·장소를 문장 안에 자연스럽게 넣어 안내합니다. 그다음 이번 회의에서 다룰 안건을 줄 앞에 가운뎃점(·)을 붙여 한 줄씩 적습니다. ' +
      '마지막으로 회의에서 다루었으면 하는 의견이 있으면 어린이집으로 알려 달라는 부탁과, 회의 결과는 안내문으로 공개하겠다는 안내를 덧붙입니다. ' +
      '전체 8~12줄 정도로 씁니다.',
  },
  ...
  minutes: {
    ...
    system:
      ...
      '[회의순서] order — 1. 개회사 로 시작해 안건을 차례로 넣고 마지막을 기타 안건, 폐회사 로 맺습니다. 한 줄에 하나씩 번호를 붙입니다.\n' +
      '[토의 및 의결사항] discussion — 안건마다 다음 모양을 지킵니다.\n' +
      '  1. 안건 이름\n' +
      '   - 어린이집이 보고하거나 설명한 내용을 문장으로 씁니다. 필요하면 ① ② ③ 으로 나눕니다.\n' +
      '   ● (운영위원) 위원이 낸 의견을 한두 문장으로 씁니다.\n' +
      '   → 그 의견에 대한 어린이집의 답변을 씁니다.\n' +
      '안건 사이는 빈 줄로 나눕니다. 메모에 위원 의견이 없으면 ● 줄은 넣지 않습니다. ' +
      '마지막에는 기타의견 이라는 줄을 두고 그 아래에 ● 《어린이집》 또는 ● 《운영위원》 으로 시작하는 줄을 필요한 만큼 씁니다. 없으면 기타의견 부분은 넣지 않습니다.\n' +
      '아래 JSON 하나만 출력합니다. {"order":"회의순서","discussion":"토의 및 의결사항"}',
  },
  // 회의 후 부모에게 알리는 결과 안내문 본문 (원장님 어린이집 서식 그대로)
  result: {
    system: `${BASE_RULE} 지금 쓸 것은 어린이집 운영위원회 회의결과 안내문의 본문이며, 아래 서식을 그대로 지킵니다.\n` +
      '첫 줄 : 회의를 연 날짜와 방식을 한 문장으로 밝힙니다. 예) 2026년 2월 2일(월)에 개최되었으며 대면회의를 진행하였고 결과를 다음과 같이 안내합니다.\n' +
      '그다음 줄 : 1. 운영위원회 안건내용\n' +
      '그 아래 안건마다 다음 모양을 지킵니다.\n' +
      '   1) 안건 이름\n' +
      '       ● 《어린이집》 어린이집이 보고·설명한 내용을 개조식으로 씁니다. 여러 가지면 ① ② ③ 으로 나눕니다.\n' +
      '       ● 《운영위원》 위원이 낸 의견이 있으면 씁니다.\n' +
      '           → 그 의견에 대한 답변을 씁니다.\n' +
      '안건 번호는 1) 2) 3) 순으로 붙이고, 마지막 항목은 기타의견 으로 둘 수 있습니다. ' +
      '문장은 안내문답게 ~함, ~하겠음 처럼 개조식으로 맺습니다. ' +
      '맨 마지막에 ★ 로 시작하는 감사 인사를 3~5줄 덧붙입니다. 운영위원과 부모님께 감사하는 내용으로 씁니다.',
  },
