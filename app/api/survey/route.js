...
const KINDS = {
  // 문서 맨 앞 — 조사의 필요성
  need: {
    system: `${BASE_RULE} 지금 쓸 것은 학부모 만족도 조사의 필요성입니다. `
      + '학부모의 의견을 듣고 어린이집 운영에 반영하는 일이 왜 필요한지, 그것이 보육의 질과 어떻게 이어지는지를 씁니다.\n'
      + '반드시 담아야 하는 내용이 있습니다. 매년 1회 전체 학부모를 대상으로 만족도 조사를 실시하고, '
      + '그 결과를 전체 학부모에게 공개하며, 개선이 필요한 부분을 다음 해 운영 계획에 반영함으로써 '
      + '투명한 어린이집 운영을 실천한다는 내용입니다.\n'
      + '무기명 조사라는 점과 열린어린이집 운영의 기초 자료로 쓰인다는 점도 함께 씁니다. '
      + '세 문단, 모두 합쳐 8~10문장으로 쓰고 문단 사이는 줄바꿈합니다. 정중한 존댓말로 씁니다.',
  },
  // 조사 전에 부모에게 보내는 공지문 (일시·대상·방법은 표로 들어가므로 인사말과 맺음말만)
  notice: {
    json: true,
    system: `${BASE_RULE} 지금 쓸 것은 학부모 만족도 조사 실시 안내문(가정통신문)의 인사말과 맺음말입니다. `
      + '조사 기간·대상·방법·내용은 문서에서 표로 따로 보여주므로 인사말과 맺음말에 다시 나열하지 않습니다.\n'
      + 'greeting : 학부모님께 드리는 인사로 시작해, 의견을 운영에 반영하기 위해 만족도 조사를 실시한다는 것과 '
      + '무기명으로 진행되며 응답은 운영 개선 자료로만 쓰인다는 안내까지 3~4문장. 한 문장씩 줄바꿈합니다.\n'
      + 'closing : 기한 내 제출을 부탁드리는 말과, 주신 의견을 다음 해 운영 계획에 반영하겠다는 약속을 2~3문장. 한 문장씩 줄바꿈합니다.\n'
      + '아래 JSON 하나만 출력합니다. {"greeting":"인사말","closing":"맺음말"}',
  },
  // 결과내용을 통한 내년 반영 내용
  plan: {
    system: `${BASE_RULE} 지금 쓸 것은 만족도 조사 결과를 다음 해 어린이집 운영에 어떻게 반영할지에 대한 계획입니다. `
      + '알려준 영역별 점수와 부모 의견을 근거로 씁니다. 점수를 바꾸거나 새로 만들지 않습니다.\n'
      + '가장 낮게 나온 영역을 우선 개선 과제로 삼는다는 내용을 반드시 넣고, '
      + '건의 사항을 항목별로 정리해 담당자와 시기를 정해 실행한다는 내용, '
      + '개선 과정을 운영위원회와 가정통신문으로 학부모에게 안내한다는 내용, '
      + '다음 해에도 조사를 실시해 개선 여부를 확인한다는 내용을 담습니다.\n'
      + '첫째, 둘째, 셋째, 넷째 로 시작하는 항목을 한 줄에 하나씩 쓰고, 맨 앞에는 이끄는 문장 한 줄을 둡니다. '
      + '문장은 ~하겠습니다 로 맺습니다.',
  },
  // 설문지 맨 앞 인사말
  intro: {
