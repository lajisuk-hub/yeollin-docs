...
export const NEW_DOCS = [
  {
    ...
    ready: true,
    desc: '가진 자료가 없어도 됩니다. 기본사항에 등록한 반·원아 명단으로 상담 안내문부터 신청서·일정표·기록지·운영 결과까지 한 번에 만듭니다.',
    makes: ['부모 상담 안내문', '상담 신청서 양식', '반별 상담 일정표', '원아별 상담 기록지', '운영 결과 정리'],
    fields: [
  ...
  { id: 'committee-new', name: '운영위원회 (개최 안내문·회의록·결과 안내문)', area: '2-나. 운영위원회 (10점)', freq: '분기별 1회', ready: false },
  { id: 'program-new', name: '부모참여프로그램 (연간계획 + 실시기록)', area: '2-다. 부모참여프로그램 (5점)', freq: '반기별 1회', ready: false },
  { id: 'survey-new', name: '부모만족도조사 (설문지·결과 보고서)', area: '2-라. 부모만족도 조사 (10점)', freq: '연 1회', ready: false },
  { id: 'link-new', name: '연계·협력 활동 (계획·실시기록)', area: '3. 다양성 (15점)', freq: '연 2회 이상', ready: false },
];
