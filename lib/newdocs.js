...
export const NEW_DOCS = [
  ...
  {
    id: 'visit-new',
    name: '부모 어린이집 참관 (게시문·운영계획)',
    area: '2-마. 부모 어린이집 참관 (5점)',
    freq: '연중 상시 운영 · 현장확인',
    ready: true,
    wizard: 'visit', // 한 단계씩 물어보며 만드는 방식 (app/VisitWizard.js)
    desc: '⚠️ 서류를 내는 항목이 아니라 현장에서 확인하는 항목입니다. 심사위원이 게시된 안내문을 눈으로 보고, 상시 운영 여부를 면담으로 묻습니다. 벽에 붙일 게시용 안내문(자격·시기·방법 포함)과 상시 운영 계획을 만들어 드립니다.',
    makes: ['게시용 참관 안내문 (현관·게시판에 붙이는 한 장)', '참관 상시 운영 계획 (면담 대비)', '참관 신청서 양식', '참관 기록지', 'PDF · 한글(hwpx) 저장'],
  },
  {
    id: 'survey-new',
  ...
  },
  {
    ...
    makes: ['연계·협력 활동의 필요성', '연간계획표 (시기·활동명·연계 대상·인정 항목)', '활동별 안내문', '활동별 실시기록 (운영일시·참석자·활동내용)', '항목별 충족 현황 확인 (화면에서만)', 'PDF · 한글(hwpx) 저장'],
  },
  {
    id: 'local-new',
    name: '지자체 자체기준 충족 내용',
    area: '4. 지자체 자체 선정기준 (15점)',
    freq: '관할 지자체가 정한 항목마다',
    ready: true,
    wizard: 'local', // 자료를 올려 정리하는 방식 (app/LocalTidy.js)
    desc: '지자체 자체기준은 관할 시·군·구마다 항목이 다릅니다. 우리 원이 충족한 자료(수료증·참석확인서·공문 등)를 올리면 AI가 읽어서 항목별로 정리하고, 지자체 문서로 따로 만들어 드립니다. 자료가 없으면 직접 적으셔도 됩니다.',
    makes: ['지자체 자체기준 안내글', '충족 내용 표 (항목·일시·주관·참석자·증빙)', '항목별 내용과 증빙 자료', '빠진 항목 확인 안내', 'PDF · 한글(hwpx) 저장'],
  },
];
