...
export const DOCS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'date', label: '회의 일시', type: 'text', placeholder: '예) 2025. 3. 20.(목) 오후 5시' },
      ...
      { key: 'agenda', label: '안건', type: 'textarea', placeholder: '안건을 줄 또는 쉼표로. 예) 2025년 급식 운영 계획, 여름철 안전관리, 부모참여수업 일정' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'quarter', label: '회차', type: 'select', options: ['1분기', '2분기', '3분기', '4분기'] },
      { key: 'when', label: '회의 일시', type: 'text', placeholder: '예) 2025. 3. 20.(목) 오후 5시' },
    ...
    build: (v, ai) => [
      ...
      { type: 'sign', text: `${v.date || '2025년    월    일'}`, role: `${v.centerName || ''} 원장`, name: v.principal },
    ],
  },
  {
    id: 'open-day',
  ...
  },
  {
    ...
    fields: [
      ...commonHead,
      { key: 'period', label: '조사 기간', type: 'text', placeholder: '예) 2025. 11. 3. ~ 11. 14.' },
  ...
  },
  {
    ...
    fields: [
      ...commonHead,
      { key: 'date', label: '작성일', type: 'text', placeholder: '예) 2025년 3월 4일' },
      { key: 'principal', label: '원장 이름', type: 'text' },
    ],
    ai: null,
    build: (v) => [
      ...
      { type: 'sign', text: v.date || '2025년    월    일', role: `${v.centerName || '○○어린이집'} 원장`, name: v.principal },
    ],
  },
  {
    id: 'visit-form',
    ...
    build: (v) => [
      ...
      { type: 'sign', text: '2025년    월    일', role: '신청인(보호자)', name: '(서명 또는 인)' },
    ],
  },
