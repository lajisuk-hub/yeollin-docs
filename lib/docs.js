...
export const AREAS = [
  ...
  // 지자체는 항목이 지역마다 달라 서류 카드 대신 전용 화면으로 간다
  { id: 'local', label: '지자체', color: '#6B7280', single: 'local-tidy' },
];
...
export const DOCS = [
  ...
  // 가지고 있는 자료를 올려 한 흐름으로 정리하는 방식 (권장)
  {
    ...
    area: 'join',
    tidy: 'program',
    name: '부모참여프로그램 서류 정리 (열린어린이집의 날)',
    freq: '연간계획 1개 + 실시기록 (월별 또는 분기별)',
    item: '2-다. 부모참여프로그램 (5점)',
    desc: '가지고 있는 연간 운영계획(PDF)을 올리고, 3월부터 진행한 실시기록을 차례로 올리면 AI가 읽어서 한 문서로 정리합니다. 달마다 활동 사진 2장 이상이 필요하고, 평가는 실시기록을 보고 AI가 분석해 씁니다.',
    fields: [],
    build: () => [],
  },
  {
    ...
    area: 'join',
    legacy: true,
    hidden: true,   // 목록에서 감춤 — 위의 '부모참여프로그램 서류 정리'가 이 내용을 모두 포함한다
    name: '부모참여프로그램(열린어린이집의 날) 실시기록',
    freq: '반기별 1회 이상 (연 2회)',
    item: '2-다. 부모참여프로그램 (5점)',
    desc: '열린어린이집의 날(부모참여수업·재능기부 등) 실시 기록을 한 장으로 만듭니다. (위의 "부모참여프로그램 서류 정리"에 이미 들어 있습니다.)',
    fields: [
      ...commonHead,
  ...
  // 가지고 있는 자료를 올려 한 흐름으로 정리하는 방식 (권장)
  {
    ...
    area: 'join',
    tidy: 'survey',
    name: '부모만족도조사 서류 정리 (연 1회)',
    freq: '연 1회 (지난해 자료로 정리)',
    item: '2-라. 부모만족도 조사 (10점)',
    desc: '조사 공지와 설문 응답 자료를 올리면(파일이 많으면 ZIP으로 묶어서) AI가 읽어서 항목별 평균 점수와 그래프가 있는 결과서까지 한 문서로 정리합니다.',
    fields: [],
    build: () => [],
  },
  {
    ...
    area: 'join',
    legacy: true,
    hidden: true,   // 목록에서 감춤 — 위의 '부모만족도조사 서류 정리'가 이 내용을 모두 포함한다
    name: '부모만족도조사 결과 보고서',
    freq: '연 1회',
    item: '2-라. 부모만족도 조사 (10점)',
    desc: '부모만족도조사 결과를 정리한 보고서를 한 장으로 만듭니다. (위의 "부모만족도조사 서류 정리"에 이미 들어 있습니다.)',
    fields: [
      ...commonHead,
  ...
  // 안내문과 신청서를 한 서류로 합쳤다 (원장님 지시 — 두 카드가 같은 내용이었음)
  {
    id: 'visit-tidy',
    area: 'join',
    tidy: 'visit',
    name: '어린이집 참관 서류 정리 (안내문 + 신청서)',
    freq: '연중 상시 운영 · 현장확인 항목',
    item: '2-마. 부모 어린이집 참관 (5점)',
    desc: '게시하고 계신 참관 안내문과 신청서 양식을 올리면, 안내문에 참관 자격·시기·방법이 들어 있는지 AI가 점검해 드립니다. 참관하신 분의 기록과 사진까지 넣어 한 문서로 정리합니다.',
    fields: [],
    build: () => [],
  },
  {
    ...
    area: 'join',
    legacy: true,
    hidden: true,   // 목록에서 감춤 — 위의 '어린이집 참관 서류 정리'로 합쳤다
    name: '어린이집 개방(참관) 안내문',
    freq: '연중 상시 게시',
    item: '2-마. 부모 어린이집 참관 (5점)',
  ...
  // 가지고 있는 자료를 올려 한 흐름으로 정리하는 방식 (권장)
  {
    ...
    area: 'diverse',
    tidy: 'link',
    name: '연계·협력 서류 정리 (다양성)',
    freq: '어린이집 간 연 2회 + 지역사회 연계 연 2회 이상',
    item: '3-가/3-나. 어린이집 간 / 지역사회 연계 (10·5점)',
    desc: '연간계획이 있으면 올리고, 없으면 실시한 활동으로 간이 연간계획을 만들어 드립니다. 회차마다 날짜·행사이름·참여인원·참여명단·사진을 넣고 결과보고서를 올리면 AI가 진행내용과 평가로 정리합니다.',
    fields: [],
    build: () => [],
  },
  {
    ...
    area: 'diverse',
    legacy: true,
    hidden: true,   // 목록에서 감춤 — 위의 '연계·협력 서류 정리'가 이 내용을 모두 포함한다
    name: '연계·협력 활동 실시기록',
    freq: '연 2회 이상',
...
export const KEY_SCHEDULE = [
  ...
  { doc: '부모참여프로그램(열린어린이집의 날) 실시기록', area: 'join', freq: '반기별 1회', yearly: '연 2회', emphasize: false },
