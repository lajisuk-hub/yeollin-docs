...
export const emptyRound = () => ({
  ...
  noticeBg: DEFAULT_BG, noticeTop: 33, noticeBottom: 17, noticeScale: 1,
  apply: '', applyFeedback: '',
...
export function noticeBlock(r, i, center) {
  ...
  return {
    ...
    top: Number(r.noticeTop) || 33,
    bottom: Number(r.noticeBottom) || 17,
    ...
    questions: toList(r.noticeQuestions).length ? toList(r.noticeQuestions) : DEFAULT_QUESTIONS,
  };
}
