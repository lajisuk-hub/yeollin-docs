...
export const emptyRound = () => ({
  ...
  noticeBg: DEFAULT_BG, noticeTop: 30, noticeBottom: 20, noticeScale: 1, noticeAsk: true,
  apply: '', applyFeedback: '', applyIntro: '', applyTopics: '',
  applyBg: DEFAULT_APPLY_BG, applyTop: 27, applyBottom: 15, applyScale: 1,
...
export function applyBlock(r, i, center) {
  ...
  return {
    ...
    textScale: Number(r.applyScale) || 1,
